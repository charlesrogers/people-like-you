      ...
      <div className="mx-auto max-w-2xl px-6 py-24">
        ...
        <div className="mt-10 space-y-8 text-base leading-7 text-stone-600">
          ...
          <section>
            ...
            <p className="mt-3">
              To keep members safe, photos and profile content are automatically screened for
              objectionable material before they&rsquo;re shown to anyone. Your private conversations are
              not scanned. When you report someone, our team may review the relevant conversation to act
              on your report &mdash; but we do not read your private conversations otherwise.
            </p>
          </section>
