...
export const QUESTION_BANK: PromptDef[] = [
  ...
  { id: 'unpopular_take', short: "The take you've had to defend", text: "What's the take you've had to defend out loud? Who's still mad at you about it?", helpText: TRIVIA, exampleAnswer: "Die Hard is not a Christmas movie. I made a slide deck. I presented it at Thanksgiving. My brother-in-law texts me the poster every December first.", tier: 'self_expansion', category: 'humor' },
  ...
  { id: 'notice_first', short: "What you notice that nobody else does", text: "What do you notice everywhere that nobody else does? When did it last ruin something?", helpText: TRIVIA, exampleAnswer: "Continuity errors. I said 'her coffee refilled itself' out loud during a thriller and my girlfriend paused it and issued a formal warning.", tier: 'i_sharing', category: 'depth' },
