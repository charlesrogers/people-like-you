...
- **2026-08-22 — Matching v2 exploration**: decision memo written (`specs/matching-v2-decision-memo.md`) — pitch-learning architecture (sequential same-candidate style experiment), reader quiz battery options, cohort-size launch math. Awaiting Charles's D1–D10 picks; then `matching_algo-v1.md` gets superseded by a v2 spec. Nothing built; model still frozen.
