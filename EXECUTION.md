...
| Crons (GitHub Actions, `.github/workflows/crons.yml`, fire from main only) | deliver-matches (hourly :00), disclosure-expiry (:15), post-date-checkin (:30), pre-date-nudge (*/6h :45), second-date-check (daily 06:50 UTC) |
