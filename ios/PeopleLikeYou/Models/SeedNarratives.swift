...
struct SeedNarrative: Identifiable {
    let id: String
...
let seedNarratives: [SeedNarrative] = [
    // Women (shown to men)
    SeedNarrative(id: "seed_f_explorer", gender: "Woman", name: "Maya", style: "explorer",
    ...
    SeedNarrative(id: "seed_f_nester", gender: "Woman", name: "Emma", style: "nester",
    ...
    SeedNarrative(id: "seed_f_intellectual", gender: "Woman", name: "Priya", style: "intellectual",
    ...
    SeedNarrative(id: "seed_f_spark", gender: "Woman", name: "Jordan", style: "spark",
    ...
    SeedNarrative(id: "seed_f_vulnerability", gender: "Woman", name: "Lily", style: "nester",
    ...
    SeedNarrative(id: "seed_f_ambition", gender: "Woman", name: "Zara", style: "intellectual",
    ...
    // Men (shown to women)
    SeedNarrative(id: "seed_m_explorer", gender: "Man", name: "Marcus", style: "explorer",
    ...
    SeedNarrative(id: "seed_m_nester", gender: "Man", name: "Daniel", style: "nester",
        ...
        attributes: ["kindness", "values", "vulnerability"]),
    SeedNarrative(id: "seed_m_intellectual", gender: "Man", name: "Kai", style: "intellectual",
    ...
    SeedNarrative(id: "seed_m_spark", gender: "Man", name: "Leo", style: "spark",
    ...
    SeedNarrative(id: "seed_m_vulnerability", gender: "Man", name: "Ethan", style: "nester",
    ...
    SeedNarrative(id: "seed_m_ambition", gender: "Man", name: "Sam", style: "intellectual",
...
let attributeTags = [
    ("humor", "Their humor"),
    ("ambition", "Their ambition"),
    ("story", "Their story"),
    ("values", "Their values"),
    ("interests", "Their interests"),
    ("vulnerability", "Their vulnerability"),
    ("kindness", "Their kindness"),
    ("adventure", "Their sense of adventure"),
]

func getSeedNarrativesForGender(_ gender: String, count: Int = 6) -> [SeedNarrative] {
    let pool = seedNarratives.filter { $0.gender == gender }
